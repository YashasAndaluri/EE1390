...
for j in range(1,81):
	for k in range(1,26):
		b = commands[0]+"__"+str(j)+"_"+str(k)+".wav"
		#print b
...
for j in range(1,81):                       # reading all the forward.wav files, coverting to mfcc format, adding labels and storing in an array
	for k in range(1,26):
		b = commands[1]+"__"+str(j)+"_"+str(k)+".wav"
		#print b
		data, samplerate = sf.read(b)
		data1 = mfcc(data,samplerate)
		data = data1.reshape(4043,)
...
for j in range(1,81):                        # reading all the left.wav files, coverting to mfcc format, adding labels and storing in an array
	for k in range(1,26):
		b = commands[2]+"__"+str(j)+"_"+str(k)+".wav"
		#print b
		data, samplerate = sf.read(b)
		data1 = mfcc(data,samplerate)
		data = data1.reshape(4043,)
...
for j in range(1,81):
	for k in range(1,26):
		b = commands[3]+"__"+str(j)+"_"+str(k)+".wav"
		#print b
		data, samplerate = sf.read(b)
		data1 = mfcc(data,samplerate)
		data = data1.reshape(4043,)
...
for j in range(1,81):
	for k in range(1,26):
		b = commands[4]+"__"+str(j)+"_"+str(k)+".wav"
		#print b
		data, samplerate = sf.read(b)
		data1 = mfcc(data,samplerate)
		data = data1.reshape(4043,)
